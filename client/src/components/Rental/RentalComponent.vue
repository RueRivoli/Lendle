          ...
          <el-form label-position="top" label-width="80px">
            ...
            <el-col  :span="15" :offset="2">
                ...
                <table-demands-component 
                  ...
                  @change-rental="changeRental" 
                  v-if="$route.params.isLocation === '0'"
                  >
                  </table-demands-component>
                 <table-locations-component 
                  ...
                  @display-dialog="displayDialog"
                  @change-rental="changeRental" 
                  v-if="$route.params.isLocation === '1'"
                  >
                  </table-locations-component>
...
export default {
  ...
  components: { NavComponent, FooterComponent, BreadcrumpComponent, TableDemandsComponent, TableLocationsComponent },
  data() {
    return {
      rental_id: null,
      furnit_id: null,
